...
In the interpretation of uncertainty expressions, a process of mapping discrete linguistic expressions to continuous event probabilities, such an account is not applicable here because
there is no continuous signal to be normalized prior to linguistic processing. For this reason, I do not discuss this account further in this chapter.} 
