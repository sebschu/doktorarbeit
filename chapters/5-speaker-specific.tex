...
\cite{Yildirim2016} showed that listeners update their expectations about how a specific speaker uses the quantifiers 
\textit{some} or \textit{many} after being briefly exposed to a specific speaker. 
In line with their results, \cite{Schuster2018} found that listeners update their expectations of how a specific speaker
...
In this work, we build on the recent work by \cite{Schuster2018} on 
...
In both of our experiments, we build upon the semantic adaptation paradigm used in \cite{Schuster2018}, 
...
\cite{Schuster2018} propose a computational model of semantic adaptation. According to this model, when interacting with a speaker 
