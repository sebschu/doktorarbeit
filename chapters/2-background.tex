...
* we know adaptation and other partner-specific behavior happens

* seems to be both an effect of short-term activation of representations and long-term learning

* a lot of it seems to he tied to utility --> there is considerable evidence that we only adapt when it is somewhat useful for comprehension (phonemes that vary across speakers; semantics; )

* lots of work has happened with syntax and phonetics, much less with semantics/pragmatics
