...
For auxiliaries, on the other hand, there have been some debates about whether the threshold should be context-sensitive. The general consensus is that if one adopts a threshold semantics,
...
The Rational Speech Act (RSA; \citeauthor{Goodman2016}, \citeyear{Goodman2016}, see also \citeauthor{Franke2016b}, \citeyear{Franke2016b}) framework provides a computational-level
...
According to an RSA model, two types of agents engage in a communicative game: speaker agents $S$ and listener agents $L$. The goal of a speaker agent is to communicate
...
For some phenomena, though, RSA models that start of with a literal speaker $S_0$ have been proposed \egcite{Qing2019}.}
...
In practice, however, this recursive process is usually capped at the $S_1$ and $L_1$ level (\citeauthor{Franke2016}, \citeyear{Franke2016}; but cf. \citeauthor{Lassiter2017b}, \citeyear{Lassiter2017b}; \citeauthor{Bergen2016}, \citeyear{Bergen2016}) and the models
