...
\todo{make a figure visually explaining episodic memory accounts}
...
of sentences is shared across conversational partners \egcite{Garrod1987}, and \textcite{Pickering2004} argue that alignment and the joint productions in dialog happen
...
In comprehension, there have been more conflicting results about whether priming happens independent of lexical overlap or not.
...
In the subsequent chapters of this dissertation, however, I will only consider comprehension behavior, and I will only focus on cumulative adaptation
...
I will also omit discussions of the important connections between modals and conditionals \parencite[see, e.g.,][]{Lewis1973,Kratzer1979,Kratzer2012}
...
\egcite{Swanson2006,Yalcin2010,Lassiter2016}. The truth condition of utterances with epistemic modals is then determined by whether
...
This account is inspired by accounts of gradable adjectives \egcite{Kennedy2007} and the observation that many 
epistemic modals are likely gradable adjectives. For example, \textcite{Lassiter2016} argues that \textit{possible}, \textit{probable},
...
that  \textit{might} is only true for probabilities greater than $\theta_{might} = \mu > 0$. Based on data from truth value judgement tasks, \textcite{Lassiter2016} 
...
To conclude this section, while the question of how thresholds should be set has not been fully settled, this account has--unlike the two previous accounts that I presented--the 
